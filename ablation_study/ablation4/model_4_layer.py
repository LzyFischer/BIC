...
class InteractModel(nn.Module):
    ...
    def __init__(self, num_property_dim=5, cat_property_dim=3, tweet_dim=768,
        ...
        self.Model_3 = RespectiveLayer(in_channels_for_graph=hidden_dim, in_channels_for_text=hidden_dim, out_channels=output_dim, attention_dim=attention_dim, graph_num_heads=graph_num_heads, device=self.device)
        ...
        self.attention_linear = nn.Linear(attention_dim * attention_dim * 4, output_dim // 3)
    ...
    def forward(self, text, user_neighbor_index, num_feature, cat_feature, tweet_feature, des_feature, edge_index):
        ...
        attention_vec = torch.cat((attention_vec_0, attention_vec_1, attention_vec_2, attention_vec_3), dim=-1)
