...
from src.case_model1 import InteractModel
...
class AttentionWeight:
    def __init__(self, all_loader=None, human_loader=None, bot_loader=None, model=InteractModel, dropout=0.5, 
                state_dict_path='state_dict.tar', device='cuda:1', result_path='result.txt'):
        self.device = device
    ...
    def save_all(self):
        ...
        torch.save(att_weight_0, 'att_weight_0.pt')
        torch.save(att_weight_1, 'att_weight_1.pt')
...
if __name__ == '__main__':
    ...
    val_loader = DataLoader(bot_dataset, batch_size=BATCH_SIZE, shuffle=False, collate_fn=my_collate)
